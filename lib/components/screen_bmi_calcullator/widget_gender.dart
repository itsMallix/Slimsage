        ...
        children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.male, color: DesignSystem.black, size: 45),
                      SizedBox(height: 10),
                      Text("Male", style: DesignSystem.headlineSmall),
                    ],
                  ),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.female, color: DesignSystem.black, size: 45),
                      SizedBox(height: 10),
                      Text("Female", style: DesignSystem.headlineSmall),
                    ],
                  ),
                ),
              ),
          ...
          Container(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Text("HEIGHT", style: DesignSystem.headlineMedium),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  mainAxisAlignment: MainAxisAlignment.center,
                  textBaseline: TextBaseline.alphabetic,
                  children: [
                    Text(height.toString(), style: DesignSystem.headlineSmall),
                    const Text("cm", style: DesignSystem.bodyLarge),
                  ],
                ),
                SliderTheme(
          ...
          Row(
            children: [
              Container(
                ...
                child: Column(
                  children: [
                    const Text("Weight", style: DesignSystem.headlineSmall),
                    const SizedBox(height: 20),
                    Text(weight.toString(), style: DesignSystem.headlineSmall),
                    const SizedBox(height: 20),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      mainAxisAlignment: MainAxisAlignment.center,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text("Age", style: DesignSystem.headlineSmall),
                    const SizedBox(height: 20),
                    Text(age.toString(), style: DesignSystem.headlineSmall),
                    const SizedBox(height: 20),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      mainAxisAlignment: MainAxisAlignment.center,
