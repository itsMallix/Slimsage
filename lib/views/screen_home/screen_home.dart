...
import 'package:miniproject/views/screen_recommendation/screen_home_recommendation_option2.dart';
                ...
                child: Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 20),
                      Text("Favorite Meals", style: DesignSystem.headlineSmall),
                    ],
                  ),
                ),
              ),
                ...
                child: Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 20),
                      Text("Favorite Place", style: DesignSystem.headlineSmall),
                    ],
                  ),
                ),
              ),
