...
class _MealScreenState extends State<MealScreen> {
  ...
  Future<void> fetchMealsByDiet(String diet) async {
    ...
    try {
      ...
      final fetchMelas = results.map((meal) {
        return MealsModel(
          id: meal['id'],
          title: meal['title'],
          image: meal['image'],
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Row(
                children: [
                  Text("Good For Diet", style: DesignSystem.headlineSmall),
                  Spacer(),
                ],
              ),
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () async {
                      // FIX MASALAH 1: Tambahkan async/await dan loading indicator
                      ...
                      // Await fetch data sampai selesai
                      await fetchMealsByDiet(selectedDiet);
                      ...
                      // Baru navigate ke halaman list setelah data ready
                      if (context.mounted) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
