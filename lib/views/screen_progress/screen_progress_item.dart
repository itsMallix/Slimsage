...
class _ProgressItemState extends State<ProgressItem> {
  ...
  void initState() {
    ...
    if (widget.progresModel != null) {
      ...
      if (widget.progresModel!.imagePath != null &&
          widget.progresModel!.imagePath!.isNotEmpty) {
        imageFile = File(widget.progresModel!.imagePath!);
      }
    }
  }
  ...
  getFromGallery() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Access denied or action canceled.")),
      );
    }
  }
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text("Action canceled.")));
      }
    } on PlatformException catch (e) {
      ScaffoldMessenger.of(
        context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _isUpdate ? "Edit Progress" : "Add Progress",
            ...
            children: [
              ...
              Align(
                ...
                child: FloatingActionButton(
                  ...
                  child: const Icon(Icons.save, color: DesignSystem.white),
                ),
              ),
            ],
          ),
